...
| Prop          | Valid types                                                 | Valid values                                                                            | Default value | Description                                                                                                                                                                                                                                               |
|:--------------|:------------------------------------------------------------|:----------------------------------------------------------------------------------------|:--------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `xs`          | integer                                                     | `0`-`12`<br>(based on default columns)<br>`hidden`<br>`autoGrow`                                                  | nill          | Sets the width of the col based the column configuration (12 by default) for the XS breakpoint and up.                                                                                                                                                    |
| `sm`          | integer                                                     | `0`-`12`<br>(based on default columns)<br>`hidden`<br>`autoGrow`                                                  | nill          | Sets the width of the col based the column configuration (12 by default) for the SM breakpoint and up.                                                                                                                                                    |
| `md`          | integer                                                     | `0`-`12`<br>(based on default columns)<br>`hidden`<br>`autoGrow`                                                  | nill          | Sets the width of the col based the column configuration (12 by default) for the MD breakpoint and up.                                                                                                                                                    |
| `lg`          | integer                                                     | `0`-`12`<br>(based on default columns)<br>`hidden`<br>`autoGrow`                                                   | nill          | Sets the width of the col based the column configuration (12 by default) for the LG breakpoint and up.                                                                                                                                                    |
...
| `elementType` | string,<br>[object](#responsive-api-using-objects)          | `'div'`<br>`'span'`                                                                     | `'div'`       | This enables you to change the HTML element type generated.                                                                                                                                                                                               |
| `autoGrow` | bool,<br>[object](#responsive-api-using-objects)          | `true`<br>`false`                                                                     | `false`      | This allow to grow automatically (flex: 1;)                                                                                                                               |
| `flex` | bool,<br>[object](#responsive-api-using-objects)          | `true`<br>`false`                                                                     | `false`      | This allow to change the display property from `'block'` to `'flex'` (usefull for column flex-direction layouts)                                                                                                                                                      |
